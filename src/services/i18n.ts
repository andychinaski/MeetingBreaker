...
const translations = {
  ru: { 'menu.play': 'Играть', 'menu.leaderboard': 'Таблица лидеров', 'menu.settings': 'Настройки', 'menu.info': 'Информация', 'app.subtitle': 'Пять дней, один мяч и слишком много встреч.' },
